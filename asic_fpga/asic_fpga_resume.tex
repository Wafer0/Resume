...
\begin{document}
    ...
    \section{Skills}
        \begin{onecolentry}
            ...
            \textbf{ASIC/FPGA Tools:} OpenLane, Yosys, Sky130 PDK, Vivado, Questasim, Modelsim, Icarus Verilog, Verible, GTKWave, STA, DRC/LVS Verification \\
            \textbf{Methodologies:} UVM, SVA, PPA Optimization, Testbench Development, Functional Verification, Automated Regression, Bash Scripting, Immediate Assertions, Waveform Debugging, Git, Linux
        \end{onecolentry}
